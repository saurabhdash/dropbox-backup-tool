#!bin/bash
mode = 'all' # 'all' uploads subfolders of the current directory and single uploads current directory as a single tar file
token_file = '/hdd2/extra_home/sdash38/dropbox_keys/backup.txt' # location of the dropbox token file
